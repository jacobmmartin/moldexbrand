    ...
    return (
        <div className="content_fullwidth">
            <div className="container">
                <br/>
                <div className="one_half"><img src="https://www.moldexbrands.com/images/mold_killer.jpg" alt="" className="img_size1"/></div>

                <div className="one_half last">

                    <h3 className="title">Moldex<span className="sup">®</span> Mold &amp; Mildew Killer</h3>
                    <h5 className="green">Kills Mold &amp; Mildew.Inhibits the Growth of Mold &amp; Mildew.<br/> Fungicide, Mildewstat, Virucide*, Deodorizer and Disinfectant.</h5>

                    <p>Moldex<span className="sup">®</span> Mold Killer is an EPA registered (3-in-1) cleaner designed to KILL, CLEAN, and INHIBIT the growth of mold &amp; mildew.It quickly removes dirt, grime, mold, mildew, food residue, and other organic matter commonly found in homes, basements, attics, walls, kitchens and bathrooms.It destroys and neutralizes mold, mildew and their odors at their source.It is not a masking agent or general purpose stain remover.It’s bleach-free, phosphate free, non-abrasive disinfectant mold killer that can be used on most washable surfaces.</p>
                    <br/>
                    <p><strong>Applications: </strong> Kitchens, Bathrooms, Floors, Sinks, Showers, Garbage Cans, Fiberglass, Counters, Countertops, Tubs, Tile, Walls, Woodwood, Metal, Upholstery, Vinyl, Plastic, Stainless Steel, Granite, Campers, Cars, Boats, Hospitals, Schools, and Office Buildings.</p><br/><br/>
                ...
                <div className="two_third">
                    ...
                    <div className="tabs-content3 two">
                        ...
                        <div id="example-3-tab-2" className="tabs-panel3" >
                        ...
                        <div id="example-3-tab-3" className="tabs-panel3" >
                        ...
                        <div id="example-3-tab-4" className="tabs-panel3" >
                            <p>Product Labels: </p>
                        ...
                        <div id="example-3-tab-5" className="tabs-panel3" >
                ...
                <div className="one_third last">
                    ...
                    <ul className="list_4">
                        <li><i className="fa fa-arrow-circle-o-right"></i> Kills Mold &amp; Mildew</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> Inhibits the Growth of Mold &amp; Mildew</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> Cleans, Disinfects and Deodorizes</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> EPA Registered</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> Bleach-Free</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> Contains No Phosphates</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> Leaves a Clean Fresh Scent</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> Kills Household Germs</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> Non-Scratch Formula</li>
                        <li><i className="fa fa-arrow-circle-o-right"></i> Hospital Grade Disinfectant</li>
                    </ul>
