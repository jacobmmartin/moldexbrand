        ...
        return (
            ...
            <div className="content_fullwidth">
                <div className="one_full">
                    <div className="big_text1">Our method is <i>Kill, Clean, and Prevent</i>. It's simple really. We call it the "3 Factors in Mold Fighting™". It works because each proprietary formula targets a specific step in mold growth and builds on the previous.</div>
