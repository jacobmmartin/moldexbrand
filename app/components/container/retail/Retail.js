...
class Retail extends Component {
    constructor() {
      super();
      this.state = {
        retailLocation1: [{   title: "Ace Hardware",
        ...
        retailLocation2: [{   title: "Aubuchon",
        ...
        retailLocation3: [{   title: "Rona",
                              img: "./images/logos/rona.jpg",
                              link: "https://www.rona.ca"
                          }
                        ],
        onlineRetails: [{   title: "Amazon",
        ...
        suppliersAndDistributos1: [{  title: "HD Supply",
        ...
        suppliersAndDistributos2: [{  title: "Grainger",
